class StaticPagesController < ApplicationController
  def home
    ...
    # redis用のコード
    lectures = REDIS.zrevrangebyscore( "rank/lectures", "+inf", "-inf" ).map{ |id| Lecture.find(id) }
    ...
    # redis用のコード
    teachers = REDIS.zrevrangebyscore( "rank/teachers", "+inf", "-inf" ).map{ |id| Teacher.find(id) }
