...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    ...
    @gmail_user = User.new(name: "GmailUser", email: "user@gmil.com",password: "foobar",password_confirmation: "foobar", agreement: true, type: Apu::User, confirmed_at: Time.now, university_id: @university.id)
  ...
  test "should true agreement" do
    @user1.agreement = nil
    assert_not @user1.valid?
  end

  test "university_id should be present" do
    @user1.university_id = nil
    assert_not @user1.valid?
  end
