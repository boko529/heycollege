...
class LecturesCreateTest < ActionDispatch::IntegrationTest
  ...
  test "valid lecture create" do
    ...
    assert_difference 'Lecture.count', 1 do
      post lectures_path, params: { lecture: { name:  "日本大学史", language_used: "Japanese", lecture_type: "Language", lecture_term: "spring", lecture_size: "small", group_work: "included", user_id: 1}}
    end
    follow_redirect!
